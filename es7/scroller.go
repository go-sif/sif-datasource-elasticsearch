...
func (s *es7scroller) IsFinished() bool {
	return s.finished
}

func (s *es7scroller) ScrollDocuments(ctx context.Context) ([]gjson.Result, error) {
	if s.finished {
...
func (s *es7scroller) parseScrollResponse(res *es7api.Response) ([]gjson.Result, error) {
