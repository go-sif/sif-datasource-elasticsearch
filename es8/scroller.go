...
func (s *es8scroller) IsFinished() bool {
	return s.finished
}

func (s *es8scroller) ScrollDocuments(ctx context.Context) ([]gjson.Result, error) {
	if s.finished {
...
func (s *es8scroller) parseScrollResponse(res *es8api.Response) ([]gjson.Result, error) {
