...
import (
	...
	"github.com/go-sif/sif-datasource-elasticsearch/es6"
	"github.com/go-sif/sif/coltype"
	"github.com/go-sif/sif/schema"
	"github.com/stretchr/testify/require"
)

func TestElasticSearch6Datasource(t *testing.T) {
	...
	client, err := es6.CreateClient(
		&elasticsearch6.Config{
			Addresses: []string{"http://0.0.0.0:9200"},
		},
		&es6api.SearchRequest{Body: strings.NewReader(query)},
		"edsm",
	)
	require.Nil(t, err)
