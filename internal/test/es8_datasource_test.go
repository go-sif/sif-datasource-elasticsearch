...
import (
	...
	"github.com/go-sif/sif-datasource-elasticsearch/es8"
	"github.com/go-sif/sif/coltype"
	"github.com/go-sif/sif/schema"
	"github.com/stretchr/testify/require"
)

func TestElasticSearch8Datasource(t *testing.T) {
	t.Skip("Skipping test until Elasticsearch 8 final release.")
	...
	client, err := es8.CreateClient(
		&elasticsearch8.Config{
			Addresses: []string{"http://0.0.0.0:9200"},
		},
		&es8api.SearchRequest{Body: strings.NewReader(query)},
		"edsm",
	)
	require.Nil(t, err)
